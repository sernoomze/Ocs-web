...
if [[ $vps = "vps" ]]; then
	source="https://raw.githubusercontent.com/sernoomze/Ocs-web/master"
else
	source="https://raw.githubusercontent.com/sernoomze/Ocs-web/master"
fi
...
read -p "Password baru: " -e -i ใส่ pass DatabasePass
echo ""
...
read -p " Database Name: " -e -i ใส่ชื่อ Data DatabaseName
echo ""
...
echo "" | tee -a log-install.txt
echo "Auto Script Installer WEB By SerNooMzE"  | tee -a log-install.txt
echo "" | tee -a log-install.txt
